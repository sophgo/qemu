...
/* SOPHGO TPU extension */
DEF_HELPER_3(sg_setv, void, tl, tl, env)
DEF_HELPER_2(sg_conv, void, tl, env)
DEF_HELPER_2(sg_mnk, void, tl, env)
DEF_HELPER_2(sg_i2c, void, tl, env)
DEF_HELPER_5(sg_mtype, void, tl, tl, tl, tl, env)
DEF_HELPER_3(sg_m_x, void, ptr, tl, env)
DEF_HELPER_3(sg_move, void, ptr, ptr, env)

DEF_HELPER_3(sg_img2col, void, ptr, ptr, env)
DEF_HELPER_3(sg_mcvtnf, void, ptr, ptr, env)
DEF_HELPER_4(sg_maddf, void, ptr, ptr, ptr, env)
DEF_HELPER_4(sg_mmulf, void, ptr, ptr, ptr, env)
DEF_HELPER_4(sg_madds, void, ptr, ptr, ptr, env)
DEF_HELPER_4(sg_mtrans, void, ptr, ptr, tl, env)
DEF_HELPER_5(sg_m_vvw, void, ptr, ptr, ptr, ptr, env)

DEF_HELPER_4(sg_mquant, void, ptr, ptr, ptr, env)
DEF_HELPER_4(sg_mdequant, void, ptr, ptr, ptr, env)
DEF_HELPER_3(sg_mcopy, void, ptr, ptr, env)

DEF_HELPER_4(default_mld, void, ptr, tl, tl, env)
DEF_HELPER_7(sg_mld, void, ptr, tl, tl, tl, tl, tl, env)
DEF_HELPER_4(default_mld_t, void, ptr, tl, tl, env)
DEF_HELPER_7(sg_mld_t, void, ptr, tl, tl, tl, tl, tl, env)

DEF_HELPER_4(default_mst, void, ptr, tl, tl, env)
DEF_HELPER_7(sg_mst, void, ptr, tl, tl, tl, tl, tl, env)
DEF_HELPER_4(default_mst_t, void, ptr, tl, tl, env)
DEF_HELPER_7(sg_mst_t, void, ptr, tl, tl, tl, tl, tl, env)

DEF_HELPER_5(sg_mmaqs, void, ptr, ptr, ptr, tl, env)
DEF_HELPER_5(sg_mmaf, void, ptr, ptr, ptr, tl, env)
DEF_HELPER_5(sg_mmawf, void, ptr, ptr, ptr, tl, env)
DEF_HELPER_4(sg_mmqs, void, ptr, ptr, ptr, env)
DEF_HELPER_4(sg_mmf, void, ptr, ptr, ptr, env)
DEF_HELPER_4(sg_mmwf, void, ptr, ptr, ptr, env)