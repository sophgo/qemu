...
extern void vcix_mld_asm(int m, int n, int size, void *input, void *output);
...
int main(int argc, char **argv) {
    ...
    vcix_mld_asm(M, N, MATRIX_SIZE, input_matrix, output_matrix);
