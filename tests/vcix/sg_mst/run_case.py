...
CASE_NUMBER = 200
os.system("/opt/LLVM/install/bin/clang -static sg_mst.c sg_mst_asm.S -o sg_mst -O3 -march=rv64imafdcv_zicsr_zifencei_zfh_zba_zbb_zvfh_xsfvfnrclipxfqf_xsfvfwmaccqqq_xsfvqmaccqoq_xsfvcp_xsgmat --gcc-toolchain=/opt/riscv --sysroot=/opt/riscv/sysroot/ -g")

# data configuration
executable_path = './sg_mst'  # excutable file
...
for i in range(CASE_NUMBER):
    ...
    input_matrix = np.random.randint(-127, 127, size=(8, 8), dtype=np.int8)
