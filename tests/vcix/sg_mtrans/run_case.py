...
RSIZE = 8
CSIZE = 6
os.system("/opt/LLVM/install/bin/clang -static sg_mtrans.c sg_mtrans_asm.S -o sg_mtrans -O3 -march=rv64imafdcv_zicsr_zifencei_zfh_zba_zbb_zvfh_xsfvfnrclipxfqf_xsfvfwmaccqqq_xsfvqmaccqoq_xsfvcp_xsgmat --gcc-toolchain=/opt/riscv --sysroot=/opt/riscv/sysroot/ -g")
...
# data configuration
executable_path = './sg_mtrans'  # excutable file
...
for i in range(CASE_NUMBER):
    ...
    input = np.random.randint(-256, 256, size=(RSIZE, CSIZE), dtype=np.int32)
    output_matrix = input.T
